...
| LLM 服务 | SiliconFlow DeepSeek-R1-0528-Qwen3-8B（支持思考链） |
...
| Top-K | 向量检索返回的最相似文档数量，本系统默认 K=5 |
...
| 编号 | 功能名称 | 功能描述 | 优先级 |
|------|---------|---------|--------|
| FR-R01 | 菜谱列表 | 分页展示已审核菜谱，支持关键词搜索、难度筛选、标签筛选、预算区间筛选，可按时间/价格排序 | P0 |
...
| 编号 | 功能名称 | 功能描述 | 优先级 |
|------|---------|---------|--------|
| FR-A01 | 流式多轮对话 | 用户发送自然语言问题，系统通过 RAG 检索菜谱/心得后交由 LLM 生成回答，使用 SSE 实时流式输出 | P0 |
